...
public class LoginActivityTest {
    ...
    public void loginActivityTest() {
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView.perform(scrollTo(), replaceText("s"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatAutoCompleteTextView2 = onView(
                allOf(withId(R.id.email), withText("s"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
                ...
                allOf(withId(R.id.email), withText("s"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView3.perform(scrollTo(), replaceText("sh"));

        ViewInteraction appCompatAutoCompleteTextView4 = onView(
                allOf(withId(R.id.email), withText("sh"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
                ...
                allOf(withId(R.id.email), withText("sh"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView6.perform(scrollTo(), replaceText("sh908427@dal.ca"));

        ViewInteraction appCompatAutoCompleteTextView7 = onView(
                allOf(withId(R.id.email), withText("sh908427@dal.ca"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
                ...
                allOf(withId(R.id.password), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("123456789"));
